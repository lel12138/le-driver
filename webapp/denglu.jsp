...
<body>
<form  id="biaoge" action="/denglu" method="post">
    <!--action为表单提交的服务器地址，method为请求方式，get方式把参数全部挂在网址后面，参数有限制且不安全-->

    <div class="biaodan1">欢迎登录</div><!--h1到h6为标题-->
...
<a href="/forget?I_am=user" class="forget">忘记密码</a>
<a href="/zhuce" class="go-zhuce">新用户注册</a>
</body>
</html>
